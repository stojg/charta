;(function(h,$) {
	...
	$('document').ready(function(){
		...
		//	operation.applyToCodeMirror(editor.codemirror);
		//};
		//
		//var cmAdapter = new ot.CodeMirrorAdapter(editor.codemirror);
		//
		...
		//var STO = ot.SimpleTextOperation;
		////console.log(STO);
		//editor.codemirror.on('change', function (cm, changes) {
		//	//var operation = client.createOperation();
		//	//console.log(changes);
		//	var operation = ot.CodeMirrorAdapter.operationFromCodeMirrorChanges(changes, cm)[0];
		//	var simpleOperations = STO.fromTextOperation(operation);
		//
		//	console.log(makeCharTextOperations(simpleOperations));
		//
		//	//console.log(operation.noop())
		//	//console.log(makeCharTextOperations(operation));
		//	//_.each(_.flatten(_.map(simpleOperations, makeCharTextOperations)), addToList);
		//	//console.log(simpleOperations);
		//	//client.sendOperation(operation);
		//});

		//editor.codemirror.on("change", function(editor, operation) {
		//	//client.cre
		//	//var operation = client.createOperation();
